...
export class ViewDetailsComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private router: Router, private service: ViewDetailsService,
    private symptomDTO: SymptomDTO, private testDTO: TestDTO) {
  ...
  SubmitTest() {
    for (const Test of this.TestName) {
      ...
      this.service.AddTestByAppointmentId(this.testDTO).subscribe({
        next: (res: any) => {
          console.log(this.testDTO)
        },
        error: (err) => console.log(err)
      })
    }
  ...
  SubmitSymptom() {
    for (const symptom of this.SymptomName) {
      ...
      this.service.AddSymptomByAppointmentId(this.symptomDTO).subscribe({
        next: (res: any) => {
          console.log(res);
          console.log(this.symptomDTO);
        },
